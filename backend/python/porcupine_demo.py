...
def gettxt(service):
    with open(join(dirname(__file__), '/home/pi/Desktop/Porcupine/demo/python/speech.wav'),
          'rb') as audio_file:
...
def sendtxt():
    subprocess.call('scp /home/pi/Desktop/Porcupine/demo/python/speechdata.txt tonyx@10.19.132.116:/C:/Users/TonyX/Desktop' , shell = True)
...
if __name__ == '__main__':
    ...
    if args.show_audio_devices_info:
        ...
        while True:
            ...
            if check == True:
                print("nice")
                subprocess.call('timeout 10 arecord -D dmic_sv -c2 -r 48000 -f S32_LE -t wav -V mono speech.wav', shell = True)
